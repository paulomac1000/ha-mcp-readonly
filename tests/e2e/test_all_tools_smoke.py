...
PARAMS_MAP = {
    "automation_validate_triggers": {
        "automation_alias": "System - Socker PC Piesek",
    },
    ...
    "diagnose_person_tracking": {"person_entity": "person.pawel"},
    "diagnose_template": {"entity_id": "binary_sensor.ac_heating_economical"},
    "entity_get_context_tree": {"entity_id": "sun.sun"},
    "eval_templates_batch": {"templates": json.dumps(["{{ 1+1 }}"])},
    "get_all_states": {"domain": "sun"},
    "get_area_automation_summary": {"area_id": "Biuro"},
    "get_area_devices_summary": {"area_id": "Biuro"},
    "get_area_diagnostic": {"area_name": "Biuro"},
    "get_area_overview": {"area_id": "Biuro"},
    ...
    "get_automation_entity_id": {
        "identifier": "System - Socker PC Piesek",
    },
    ...
    "get_devices_by_area": {"area_id": "Biuro"},
    "get_entity_consumers": {"entity_id": "sun.sun"},
    "get_entity_context": {"entity_id": "person.pawel"},
    "get_entity_details": {"entity_id": "person.pawel"},
    ...
    "get_entity_with_automations": {"entity_id": "person.pawel"},
    ...
    "get_script_code": {"script_id": "speakers_in_use"},
    "get_template_dependencies": {
        "entity_id": "binary_sensor.ac_heating_economical",
    },
